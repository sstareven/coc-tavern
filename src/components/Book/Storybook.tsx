...
import { CanvasPageFlip } from './CanvasPageFlip';
...
export function Storybook() {
  ...
  const [tocFlipping, setTocFlipping] = useState(false);
  const [invFlipping, setInvFlipping] = useState(false);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Canvas curl exit — TOC */}
          {tocFlipping && (
            <CanvasPageFlip
              theme="dark"
              onComplete={() => setTocFlipping(false)}
            />
          )}
          ...
          {/* Canvas curl exit — Inventory */}
          {invFlipping && (
            <CanvasPageFlip
              theme="parchment"
              onComplete={() => setInvFlipping(false)}
            />
          )}
        ...
        <div style={{
          ...
          <button
            onClick={() => {
              ...
              if (tocFlipping || invFlipping) return;
