    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          height: 36,
          borderRadius: '50%',
          border: `1px solid ${canGoPrev ? 'var(--gold)' : 'rgba(var(--ink-faded-rgb),0.25)'}`,
          background: canGoPrev ? 'rgba(196,168,85,0.08)' : 'transparent',
          color: canGoPrev ? 'var(--gold)' : 'var(--ink-subtle)',
          fontSize: 'calc(20px * var(--text-ratio, 1))',
      ...
      <button
        ...
        style={{
          ...
          height: 36,
          borderRadius: '50%',
          border: `1px solid ${canGoNext ? 'var(--gold)' : 'rgba(var(--ink-faded-rgb),0.25)'}`,
