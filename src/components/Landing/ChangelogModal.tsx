...
export const RELEASES: Release[] = [
  {
    ...
    items: [
      ...
      '【字逐字浮现】以前每回合要等 LLM 一次性写完才看到正文。现在叙事字逐字浮现,左页头/正文/选项/总结都能跟着 KP 思路慢慢"刻"出来。设置 → 流式刻印开关可关。',
      '【多结局拯救线】坏结局不再是唯一终点。剧本作者可在编辑器配多条「拯救终局」与里程碑解锁条件,玩家解到对应里程碑就能在右页看到拯救线机会;有快照回溯,选错了能回到岔路口。',
    ],
  },
  {
    version: 'v1.16.1',
