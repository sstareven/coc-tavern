      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: 520 }}>
          ...
          <p style={{ marginTop: 64, fontSize: 10, color: 'var(--ink-subtle)', letterSpacing: 3, opacity: 0.5 }}>
            v1.3.6 · COC 7th Edition · <span onClick={() => document.dispatchEvent(new CustomEvent('show-changelog'))} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--ink-subtle)' }}>更新日志</span>
          </p>
        </div>
      </div>
