...
夜半时分，远处神庙的铜铃自鸣，街角的影子在油灯尚未点燃时已经移动起来。元老院的密令、市井的流言、神庙的禁忌——它们指向同一处。你必须决定从哪里开始。`,
  ...
  customOccupations: [
    ...
    { name: '百夫长', crMin: 30, crMax: 60, skills: ['格斗(短剑)','格斗(标枪)','战术','聆听','侦查','急救','恐吓','骑马'] },
    { name: '军团士兵', crMin: 10, crMax: 25, skills: ['格斗(短剑)','格斗(标枪)','投掷','闪避','聆听','生存','急救','骑马'] },
    ...
    { name: '商旅', crMin: 20, crMax: 50, skills: ['估价','话术','说服','聆听','心理学','语言(其他)','骑马','导航'] },
    { name: '水手', crMin: 9, crMax: 30, skills: ['游泳','攀爬','导航','聆听','格斗(斗殴)','投掷','生存','博物学'] },
    { name: '战车御者', crMin: 9, crMax: 40, skills: ['战车驾驶','骑马','急救','聆听','侦查','艺术与手艺','取悦','信用评级'] },
    { name: '奴隶', crMin: 0, crMax: 5, skills: ['聆听','潜行','藏匿','妙手','心理学','艺术与手艺','急救','侦查'] },
  ],
  customSkills: [
    { name: '骑马', base: 5, cat: '运动系', desc: '骑乘马匹与控制坐骑(罗马时代尚无现代马术装具,操控难度更高)' },
