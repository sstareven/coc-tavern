...
2. 不要把「线索/知识/信息类发现」当作地点元素——元素是地点本身的环境构成与可注意之物，与线索正交。
3. 每个元素都要给出 name、category 与 description（15-40 字的简介）。category 只能取：陈设/机关/痕迹/通道/容器/异常/其他。
4. 若本回合该地点没有任何新元素，请输出空数组。
