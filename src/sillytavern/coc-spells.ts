...
export interface CocSpell {
  ...
  /** 法术简述 */
  description: string;
  /** 是否需要 POW 对抗（针对目标的攻击/控制类法术） */
  requiresPowContest?: boolean;
}
...
export const COC_SPELLS: readonly CocSpell[] = [
  ...
  { name: '纳塞恩之歌', mpCost: 4, sanCost: 3, castingTime: '3轮', description: '吟唱异界旋律，使周围生物陷入恍惚或恐惧', requiresPowContest: true },
  { name: '灵魂附着', mpCost: 8, sanCost: 5, castingTime: '10分钟', description: '将意识暂时附着于一个物体或尸体上，感知其周围环境' },
  { name: '意志之门', mpCost: 5, sanCost: 3, castingTime: '1轮', description: '在施法者与目标之间建立短暂的心灵链接，可传递思维或情感', requiresPowContest: true },
  { name: '痛苦蛊咒', mpCost: 6, sanCost: 4, castingTime: '2轮', description: '对目标施加剧烈的幻觉痛苦，迫使其行动受阻', requiresPowContest: true },
