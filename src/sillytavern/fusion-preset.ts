...
// 'Core' 已改为更具体 'Core驱动|CoreFrontend' 避免误伤 'Core Memory' 等合法条目。
const KILL_NAME = /Core驱动|CoreFrontend|输出格式|锋芒|前端|视觉交互|日期卡片|顶部日期|小剧场|快捷回复|播放器|状态面板|htm1|自定义前端|变量更新强调|大总结|防掉格式/;
