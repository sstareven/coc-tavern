...
关键词高亮：在叙事文本中，用{{}}包裹重要的人名、地名、物品、线索等关键词（如"步入{{阿卡姆}}的街道"、"桌上放着一本{{奈克特抄本}}"）。每段叙事至少包含2-5个关键词标记。注意：不要给变量补丁块加{{}}。
...

{
  ...
  "leftHeader": "章节标题",
  "leftContent": "{{大学图书馆}}的空气中弥漫着陈旧纸张的气味，{{阿卡姆}}入夜后的寂静在书架之间沉淀。桌上放着一封{{密信}}——纸张背面的红墨水在灯下泛出锈血般的色泽，那些符号【并非静止】：每一笔都像被无形的手缓缓拉扯，蛇形的线条以一种不属于这世界的节律微微蠕动，凑近时甚至能听见极轻的、像指甲刮过铜板的摩擦声。<san id=\"p1\"/>胃里一阵翻涌，几步后撤的脚步在木地板上回响。",
  "rightHeader": "行动标题",
  "rightContent": "引导文字。",
  "choices": [
