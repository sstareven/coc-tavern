...
` }),
    ...
    mvu_var_list: e({ name: '变量列表', keys: '变量, variable, stat, 状态', logic: 'AND_ANY', priority: 8, depth: 0,
...
` }),
  ...
  coc_lore: { name: '克苏鲁深渊档案馆', enabled: true, entries: {
    arkham: e({ name: '阿卡姆镇', keys: '阿卡姆, Arkham, 新英格兰, 马萨诸塞', logic: 'AND_ANY', priority: 10,
    ...
    miskatonic: e({ name: '密斯卡塔尼克大学', keys: '密斯卡塔尼克, Miskatonic, 大学, 图书馆, 阿米蒂奇, 特殊馆藏', logic: 'AND_ANY', priority: 20,
    ...
    necronomicon: e({ name: '神话典籍', keys: '死灵之书, Necronomicon, 禁忌古籍, 魔法书, 无名祭祀书, 伊波恩之书, 妖蛆的秘密, 塞拉伊诺断章, 典籍', logic: 'AND_ANY', priority: 30,
    ...
    cthulhu: e({ name: '克苏鲁', keys: '克苏鲁, Cthulhu, 旧日支配者, 拉莱耶, 星之眷族, 克苏鲁教团', logic: 'AND_ANY', priority: 40,
    ...
    deepones: e({ name: '深潜者', keys: '深潜者, Deep One, 鱼人, 大衮, 海德拉, 两栖, 海底种族', logic: 'AND_ANY', priority: 50,
    ...
    mythos_skill: e({ name: '克苏鲁神话技能', keys: '克苏鲁神话, Cthulhu Mythos, 神话知识, 神话技能', logic: 'AND_ANY', priority: 45,
    ...
    innsmouth: e({ name: '印斯茅斯', keys: '印斯茅斯, Innsmouth, 马什船长, 印斯茅斯面容, 渔港', logic: 'AND_ANY', priority: 60,
    ...
    dunwich: e({ name: '敦威治', keys: '敦威治, Dunwich, 沃特雷, Whateley, 哨兵岭, 艾尔斯伯里, 威尔伯', logic: 'AND_ANY', priority: 55,
    ...
    yog_sothoth: e({ name: '犹格·索托斯', keys: '犹格·索托斯, Yog-Sothoth, 门之匙, 犹格, 看门者, 万物之门', logic: 'AND_ANY', priority: 42,
    ...
    nyarlathotep: e({ name: '奈亚拉托提普', keys: '奈亚拉托提普, Nyarlathotep, 伏行之混沌, 暗夜使者, 阿撒托斯, 千面化身', logic: 'AND_ANY', priority: 43,
    ...
    shub_niggurath: e({ name: '莎布·尼古拉丝', keys: '莎布·尼古拉丝, Shub-Niggurath, 黑山羊, 千子之母, 丰饶, 黑山羊幼崽', logic: 'AND_ANY', priority: 44,
    ...
    elder_things: e({ name: '远古者', keys: '远古者, Elder Things, 远古之物, 星形头部, 桶形生物, 前寒武纪, 太古代', logic: 'AND_ANY', priority: 46,
      content: '南极考察记录与某些远古壁画中，提到一种"星形头部"的远古之物——桶形的身躯、海星般的头部。它们的形象太过古怪，以致早期发现者多半将其当作某种奇异的海洋化石。\n<% if (parseInt(getvar(\'调查员.技能.克苏鲁神话\') || \'0\') > 0) { %>\n远古者(Elder Things)是地球年轻时从群星降临的古老种族：桶形躯干、五条脊状物、海星形头部与底端、可折叠的膜翼、海百合般精巧的触手肢。它们坚韧得几乎无法摧毁，能在海底高压与星际以太中生存，曾在海陆修建壮丽的巨石城市，并创造了地球上的所有生命——包括充当劳力的修格斯。它们文明高度发达，用五分法数学创作浅浮雕壁画；历经与克苏鲁眷族、米·戈的战争后退缩南极，随冰河时代迁入山脉下方的地下深渊。它们并非怪物，而是会恐惧、会创造、会衰落的智慧生物。\n<% } %>' }),
    shoggoth: e({ name: '修格斯', keys: '修格斯, Shoggoth, 原生质, 不定形, Tekeli-li, 黏液, 肿泡', logic: 'AND_ANY', priority: 47,
    ...
    mad_mountains: e({ name: '疯狂山脉', keys: '疯狂山脉, 南极山脉, 南极探险, 南极考察, 莱克教授, 冷原, 卡达斯', logic: 'AND_ANY', priority: 48,
    ...
    antarctic_abyss: e({ name: '南极深渊', keys: '深渊, 地下海, 地底城市, 地下世界, 白化企鹅, 地热海洋', logic: 'AND_ANY', priority: 49,
    ...
    ejs_combat: e({ name: 'EJS·战斗模式', keys: '战斗, 格斗, 攻击', logic: 'AND_ANY', priority: 148, constant: true,
  ...
  coc_style: { name: '洛夫克拉夫特文风', enabled: true, entries: {
    style_main: e({ name: '文风主规则', keys: '文风, 叙事, 描写', logic: 'AND_ANY', priority: 200, constant: true,
      content: '【守秘人叙事风格】\n视角：全知叙述者，保留神秘感\n时态：过去时\n句式：长句为主，大量使用破折号和分号构建复杂从句\n节奏：缓慢而沉重的叙述节奏，长句叠加形成窒息般的压迫感，偶尔以短句制造突然的恐惧冲击\n对话占比：低于描写，大部分内容应为环境渲染和心理描写\n描写重点：环境氛围、建筑与地貌细节、异常感官体验(光影/气味/声音)、心理恐惧递进、不可名状之物的暗示\n规则：\n- 单次正文(leftContent主叙事)篇幅严格控制在800字以内，宁可凝练克制，不要冗长堆砌；超长会稀释压迫感\n- 行动引导(rightContent右页)控制在200字以内，简短点出当前处境与抉择，不与正文重复铺陈\n- 恐怖元素通过暗示和间接描写传达，而非直接展示\n- NPC对话应带有地域口音和时代特色(1920年代新英格兰)\n- 检定结果融入叙事而非机械报告\n- 空间与移动逻辑：角色绝不凭空瞬移到某地。前往任何不在当前位置的地点，都必须通过步行或合理交通工具(火车/汽车/马车/船/徒步等)抵达，并简述移动过程、路线与耗时；地点变更须与上一场景在地理、距离与时间上自洽，跨城镇的远行应占用相应的天数或时辰\n- 保持洛夫克拉夫特式的学术考据风格叙述' }),
    style_technique: e({ name: '文风技法', keys: '文风技法', logic: 'AND_ANY', priority: 199, constant: true,
    ...
    style_forbidden: e({ name: '文风禁令', keys: '文风禁令', logic: 'AND_ANY', priority: 198, constant: true,
