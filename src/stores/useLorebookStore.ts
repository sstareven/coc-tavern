...
` }),
  ...
  coc_lore: { name: '克苏鲁深渊档案馆', enabled: true, entries: {
    ...
    dunwich: e({ name: '敦威治', keys: '敦威治, Dunwich, 沃特雷, Whateley, 哨兵岭', logic: 'OR', priority: 55,
    ...
    yog_sothoth: e({ name: '犹格·索托斯', keys: '犹格·索托斯, Yog-Sothoth, 门之匙, 犹格', logic: 'OR', priority: 42,
    ...
    nyarlathotep: e({ name: '奈亚拉托提普', keys: '奈亚拉托提普, Nyarlathotep, 伏行之混沌, 暗夜使者', logic: 'OR', priority: 43,
    ...
    shub_niggurath: e({ name: '莎布·尼古拉丝', keys: '莎布·尼古拉丝, Shub-Niggurath, 黑山羊, 千子之母', logic: 'OR', priority: 44,
    ...
    elder_things: e({ name: '远古者', keys: '远古者, Elder Things, 远古之物, 星形头部, 桶形生物', logic: 'OR', priority: 46,
    ...
    shoggoth: e({ name: '修格斯', keys: '修格斯, Shoggoth, 原生质, 不定形, Tekeli-li', logic: 'OR', priority: 47,
    ...
    mad_mountains: e({ name: '疯狂山脉', keys: '疯狂山脉, 南极山脉, 南极探险, 南极考察', logic: 'OR', priority: 48,
    ...
    antarctic_abyss: e({ name: '南极深渊', keys: '深渊, 地下海, 地底城市, 冷泉峡谷', logic: 'OR', priority: 49,
