...
const defaultPages: BookPage[] = [
  // ▸▸▸ 序章：降生之梦 + 命运歧路 ◂◂◂
  {
    ...
    leftContent:
      ...
      + '一道<kw>低语</kw>自湖底升起，并不像有声音响起，却径直在你颅内成形：\n'
    ...
    rightChoices: [
      {
        ...
        text: '导师的急信',
        action:
          '前几日，我收到了一封自<kw>阿卡姆</kw>寄来的挂号信。寄信人是我大学时代的导师——一位治学严谨、素来不苟言笑的老者，如今在<kw>密斯卡塔尼克大学</kw>执教。然而那潦草而急促的字迹里，既无往日的寒暄，亦无落款的日期，只余寥寥数行：「即刻动身，万勿延误。馆中新到一卷残籍，其上的文字，遍寻同侪而唯你能识。此事……恕难形诸笔墨。」信纸的边缘洇着几点干涸的褐色污渍，像是溅落的咖啡——又或者，是别的什么。\n\n'
          + '我当日清晨便登上了北行的火车。车窗外的田野在薄雾里一掠而过，车厢中乘客寥寥，一路无人交谈。抵达时已近黄昏，<kw>阿卡姆</kw>的街道沉浸在一种不合时令的死寂之中，路灯尚未点亮，湿冷的秋风自河面卷来，裹挟着若有若无的、陈年纸张与霉变交织的气味。我紧了紧大衣的领口，朝着<kw>密斯卡塔尼克大学</kw>图书馆里那几扇仍亮着昏黄灯火的窗户走去。',
      },
      {
        num: 'Ⅱ',
        text: '海风中的遗产',
        action:
          '上个月，一封措辞干涩、近乎冷漠的律师函辗转送到了我的手中：一位我几乎不曾听闻、亦从未谋面的远房亲戚已然故去，而我，据信是他在这世上仅存的继承人。所谓遗产，是海滨小镇<kw>印斯茅斯</kw>的一处旧宅——以及随函附来的一枚样式古怪的金饰；那金属触手冰凉，其上的纹路繁复而扭曲，盘绕成某种说不出名目的图案，绝非新英格兰任何一位匠人的手艺。\n\n'
          + '通往<kw>印斯茅斯</kw>的班车一日仅有一趟，破败的车厢里，自始至终只有我一名外乡的乘客。越是驶近海岸，空气里那股咸腥的气味便越是浓重——那是海水、鱼获与某种缓慢腐败之物混合而成的味道，黏稠得几乎能附着在衣领上。司机一路沉着脸不发一语，直到我下车，才压低嗓子丢来一句叮嘱：「天黑之前办完你的事，赶最后一班车离开。」暮色里，镇子在我眼前缓缓铺展开来——倾颓的屋脊、荒废的码头，以及街角那几个垂着头、迟迟不肯抬眼看我的居民。',
      },
      {
        num: 'Ⅲ',
        text: '山丘的委托',
        action:
          '事情起于一桩看似再平常不过的委托。一位素未谋面的委托人辗转寻到了我，托我代为前往<kw>敦威治</kw>——那是马萨诸塞州中北部群山褶皱深处、一处几乎被所有地图遗忘了的没落村落——去核实一桩与当地某个古老家族有关的陈年旧事。报酬丰厚得有些不合常理，而对于此事的来龙去脉，委托人却始终讳莫如深，仿佛每一个字都需斟酌再三。\n\n'
          + '载我入山的马车在黄昏时分驶进了峡谷。两侧的山丘圆得出奇——圆得太过规整，反倒透出一种说不上来的不自然；坡上的树木生得格外茂密、格外扭曲，空气里弥漫着冷泉与腐叶交织的、挥之不去的不祥气味。车夫在村口便勒住了缰绳，无论我如何许诺，都不肯再往里走半步，只抬手指了指远处半山腰上一座孤零零的农舍——据说，<kw>沃特雷</kw>家的宅子就在那附近。入夜之后，我第一次听见了那种声音：自群山深处滚滚传来的、沉闷而绵长的隆隆声，仿佛是大地本身在黑暗里低声呻吟。',
      },
      {
        num: 'Ⅳ',
        text: '极地的邀约',
        action:
          '这桩差事的开端，是<kw>密斯卡塔尼克大学</kw>一间堆满标本、终年不见天日的地下室。校方正不动声色地筹备着一支远赴南极的考察队，而我，因着某项不甚起眼的专长，被延揽为随队的一员。在正式启程之前，他们要我先替几只木箱里的样本归档造册——那些是由先遣的商船自南方带回、封存于坚冰之中、又被小心翼翼解冻开来的化石。\n\n'
          + '我至今仍清楚地记得初次见到它们时的情形。那绝非任何我所熟知的生物遗骸：桶状的躯干、星状的头部、沿身侧对称排列的奇异脊状物——它们太过完整，也太过古老，古老到不该在任何一个已知的地质年代里留下哪怕一丝痕迹。带队的教授立在我身后，呼吸里压抑着一种近乎狂热的兴奋，低声说道：「你可明白这意味着什么？这是在生命……本不该存在的纪元之前。」窗外，初冬的<kw>阿卡姆</kw>正无声无息地落下今年的第一场雪。',
      },
      {
        num: 'Ⅴ',
        text: '镇上的异变',
        action:
          '我本就客居在<kw>阿卡姆</kw>——这座古老、保守、对一切外乡人都怀着几分本能戒备的小镇，密斯卡塔尼克河自它中央静静淌过，将它分作两半。原本，日子与这镇子一样平淡无波；直到近来，接二连三的怪事打破了那层维持已久的平静。\n\n'
          + '起先，是镇北的旧墓地接连失窃——被掘走的并非什么财物，而是新近入土的遗体；继而，有夜归的渔人信誓旦旦地宣称，曾望见河水的深处泛起过一阵不属于月色的、幽幽的青光；而每当夜深人静，疯人院那一侧的高墙之后，总会断续地飘来一两声尖叫——那声音，不似任何人类的喉咙所能发出。镇上的人对此噤若寒蝉，唯有在街头巷尾压低了嗓音，含糊地提起些关于女巫、关于古老集会的、世代相传的只言片语。今夜，我终于决意不再坐视——披上外套，走进了<kw>阿卡姆</kw>湿冷而沉默的夜色之中。',
      },
    ],
    sceneInfo: {
      date: '1925年',
